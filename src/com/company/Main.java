...
public class Main {
    ...
    public static String source = "C:\\\\Java\\\\Projects\\\\text.txt"; //дефолтный файл для чтения
    public static String dest = "C:\\\\Java\\\\Projects\\\\dest.txt";//дефолтный файл для записи
    ...
    public static final String QUESTION = "ВВЕСТИ 1 ДЛЯ ШИФРОВАТЕЛЬ ВВЕСТИ 2 ДЛЯ ДЕШИФРОВАТЕЛЬ";
    ...
    public static void main(String[] args) {
        ...
        FileWriter writer = new FileWriter(dstn)) {
            ...
            int answer = scan.nextInt();//answer == 1 - шифровка, 2 -- дешифровка
    ...
    public static char[] cypher(char[] charArray, int key) {//метод для шифрования
        ...
        Arrays.sort(ALPHABET);//можно было с самого начала сделать ALPHABET отсортированным, но мне впадлу
